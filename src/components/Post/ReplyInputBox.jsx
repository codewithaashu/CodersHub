...
const ReplyInputBox = ({ placeholder = "Add a reply..." }) => {
    ...
    <>
      <div className="flex flex-col gap-2">
        <div className="flex flex-row gap-3 items-center">
          ...
          />
          <div className="w-full flex items-start justify-between h-fit  border-[1px] rounded-lg overflow-y-auto p-2 bg-white">
            {/* TextArea */}
            <div className="flex flex-col w-full gap-2">
              <textarea
                ...
                rows={1}
                className="outline-none border-none w-full resize-none overflow-hidden text-xs "
                onChange={() => {
              ...
              {image && (
                <div className="relative w-32 max-h-32 h-fit overflow-y-hidden rounded-md">
                  <Button className="absolute top-1 right-2 p-0 h-4 w-4 rounded-full cursor-pointer ">
                    <MdDelete
                      className="text-sm"
            ...
            <div className="flex flex-row gap-2 ml-3 items-center">
              ...
              {!image && (
                <label>
                  ...
                  />
                  <IoMdPhotos className="text-xl font-medium cursor-pointer h-5 w-5" />
                </label>
              )}
            </div>
            <button className="p-2 rounded-full bg-gray-100 hover:bg-gray-200 ml-3 -mt-1">
